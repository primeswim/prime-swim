...
interface FormState {
  parentEmail: string
  swimmerName: string
  groupLevel: "silver-beginner-1" | "silver-performance-1" | ""
  preferences: {
    location: string
    timeSlots: string[]
  }[]
...
export default function TrainingSurvey() {
  ...
  const updatePreference = (location: string, time: string) => {
    if (
      (form.groupLevel === "silver-beginner-1" || form.groupLevel === "silver-performance-1") &&
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-slate-800 mb-6 tracking-tight">
            Fall 2025 Silver Group Training Schedule
          </h1>
          <p className="text-xl md:text-2xl text-slate-600 mb-2 font-light">
            Help us plan the best training schedule for Silver swimmers
          </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="silver-beginner-1">Silver Beginner</SelectItem>
                          <SelectItem value="silver-performance-1">Silver Performance</SelectItem>
                        </SelectContent>
                      </Select>
                      ...
                      {form.groupLevel && required !== null && (
                        ...
                        >
                          ...
                          <div>
                            <strong>
                              {form.groupLevel === "silver-beginner-1" && "Silver Beginner-1"}
                              {form.groupLevel === "silver-performance-1" && "Silver Performance-1"}
                            </strong>{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    {Object.entries(poolOptions).map(([location, slots]) => {
                      ...
                      // ✅ Bellevue 在 Silver Beginner 和 Silver Performance 都显示
                      if (
                        location === "Bellevue Aquatic Center (Bellevue)" &&
                        !(form.groupLevel === "silver-beginner-1" || form.groupLevel === "silver-performance-1")
                      ) {
                        return null;
                      }
                      ...
                      const visibleSlots = slots.filter((slot) => {
                        if (!form.groupLevel) return false; // 未选组别不显示
                        if (form.groupLevel === "silver-beginner-1" || form.groupLevel === "silver-performance-1") {
