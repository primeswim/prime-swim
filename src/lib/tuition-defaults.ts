...
export const DEFAULT_LEVEL_CONFIG: LevelConfigMap = {
  "Bronze Beginner": {
    ...
    schedule: [
      { weekday: 6, timeSlot: "5-6PM", location: "Redmond Pool" },
    ],
    defaultTimeSlot: "5-6PM",
  ...
  "Bronze Performance": {
    ...
    reducedRatePerHour: null,
    schedule: [
      { weekday: 0, timeSlot: "4-5PM", location: "Mary Wayte Pool" },
      { weekday: 6, timeSlot: "5-6PM", location: "Mary Wayte Pool" },
      { weekday: 1, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
      { weekday: 4, timeSlot: "5-5:55PM", location: "Mary Wayte Pool" },
  ...
  "Silver Beginner": {
    ...
    schedule: [
      { weekday: 1, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
      { weekday: 2, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
      { weekday: 3, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
      { weekday: 4, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
      { weekday: 5, timeSlot: "7-8PM", location: "Mary Wayte Pool" },
    ],
    defaultTimeSlot: "7-8PM",
    defaultLocation: "Mary Wayte Pool",
  ...
  "Gold Beginner": {
    ...
    reducedRatePerHour: null,
    schedule: [
      { weekday: 2, timeSlot: "7-8:15PM", location: "Mary Wayte Pool" },
      { weekday: 4, timeSlot: "7-8:15PM", location: "Mary Wayte Pool" },
      { weekday: 5, timeSlot: "7:45-9PM", location: "Mary Wayte Pool" },
      { weekday: 6, timeSlot: "10:30AM-12PM", location: "Mary Wayte Pool" },
    ],
    defaultTimeSlot: "7-8:15PM",
    defaultLocation: "Mary Wayte Pool",
  },
  "Gold Performance": {
    defaultRatePerHour: 42,
